...
RUN wget -q $MGL_LINK && tar -xf mgltools_x86_64Linux2_$MGL_VERSION.tar.gz && \
	...
	sh -c "echo alias adt=$PROGRAMS_ROOT/mgltools_x86_64Linux2_1.5.6/bin/adt" >> $MGL_HOME/.bashrc && \
	sh -c "echo alias vision=$PROGRAMS_ROOT/mgltools_x86_64Linux2_1.5.6/bin/vision" >> $MGL_HOME/.bashrc && \
	sh -c "echo alias pythonsh=$PROGRAMS_ROOT/mgltools_x86_64Linux2_1.5.6/bin/pythonsh" >> $MGL_HOME/.bashrc
